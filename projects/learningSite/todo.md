...
- [~] Author the 54 GAP concepts — topics with no concept anywhere on the
      platform yet (36 physics, 18 math). Three themed batches done (27/54):
      foundational math (8), vector/tensor & complex-analysis math (10) and
      EM device physics (9). 27 remain across five groups — resume from
      `content/curriculum/DEPTH-GAPS.md`'s authoring order, optics group next
